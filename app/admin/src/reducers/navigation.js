...
import { FaCat, FaRegBuilding, FaBuilding, FaFile, FaInbox, FaBusinessTime } from 'react-icons/fa'
...
let initialState = [
  {
    ...
    items: [
      ...
      // },
      {
        ...
        items: [
          {
            url: '/admin/old-appointment',
            icon: <FaBuilding size={20} />,
            title: 'Old Appoinment',
            items: []
          },
          {
