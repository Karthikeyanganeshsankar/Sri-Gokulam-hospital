...
module.exports = function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.next = 10;
            return regeneratorRuntime.awrap(UpdateManyDoc(jobs, {
              category_id: ObjectId(req._id)
            }, obj, {
              multi: true
            }));
  ...
  var update_cat_name_applied_jobs = function update_cat_name_applied_jobs(req) {
    var get_data, obj, update;
    return regeneratorRuntime.async(function update_cat_name_applied_jobs$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            _context2.next = 10;
            return regeneratorRuntime.awrap(UpdateManyDoc(applied_jobs, {
              category_id: ObjectId(req._id)
            }, obj, {
              multi: true
            }));
          ...
          case 10:
            ...
            console.log("Data not found in const update_cat_name_applied_jobs ".concat(update));
          ...
          case 19:
            console.log("Data missing in const update_cat_name_applied_jobs ".concat(req));
            return _context2.abrupt("return", true);
          ...
          case 23:
            ...
            console.log("error in const update_cat_name_applied_jobs ".concat(_context2.t0));
            return _context2.abrupt("return", true);
    ...
    return regeneratorRuntime.async(function _callee$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 17:
            _context3.next = 19;
            return regeneratorRuntime.awrap(UpdateDoc(category, {
              _id: ObjectId(_id)
            }, obj, {
              multi: true
            }));
          ...
          case 19:
            ...
            if (updaqte && updaqte.nModified !== 0) {
              ...
              update_cat_name_applied_jobs({
                _id: _id
              });
            } else {
              res.json({
                status: 0,
                response: 'Category not updated'
              });
            }
          ...
          case 26:
            _check_username = _context3.sent;
          ...
          case 29:
            _context3.next = 31;
            return regeneratorRuntime.awrap(InsertDoc(category, obj));
          ...
          case 35:
            ...
            console.log("error in router['add'] ".concat(_context3.t0));
            res.json({
              status: 0,
              response: error_msg
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 15:
            ...
            console.log("error in router['edit'] ".concat(_context4.t0));
            res.json({
              status: 0,
              response: error_msg
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 25:
            ...
            console.log("error in router['delete'] ".concat(_context5.t0));
            res.json({
              status: 0,
              response: error_msg
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 25:
            ...
            console.log("error in router['restore'] ".concat(_context6.t0));
            res.json({
              status: 0,
              response: error_msg
            });
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 4:
            ...
            _context7.next = 8;
            return regeneratorRuntime.awrap(DeleteDoccs(category, {
              _id: ObjectId(_id)
            }));
          ...
          case 15:
            ...
            console.log("error in router['perm_del'] ".concat(_context7.t0));
            res.json({
              status: 0,
              response: error_msg
            });
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 9;
            return regeneratorRuntime.awrap(GetAggregationDoc(category, finalquery));
          ...
          case 13:
            ...
            console.log("error in router['list'] ".concat(_context8.t0));
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 7;
            return regeneratorRuntime.awrap(GetAggregationDoc(category, query));
          ...
          case 11:
            ...
            console.log("error in router['del_list'] ".concat(_context9.t0));
  ...
  router['get_category'] = function _callee8(req, res) {
    var response;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 7:
            ...
            console.log("error in router['get_category'] ".concat(_context10.t0));
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 8:
            ...
            if (list && checkArray(list) && list.length > 0) {
              fieldNames = ["Created On", "Category", "Status"], finaldata = list.map(function (item) {
                return {
          ...
          case 12:
            ...
            console.log("error in router['export'] ".concat(_context11.t0));
