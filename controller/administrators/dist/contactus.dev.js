...
module.exports = function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.next = 8;
            return regeneratorRuntime.awrap(GetOneDoc(contact_us, {
              _id: ObjectId(_id)
            }, {}, {}));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            obj['status'] = Number(0);
            _context2.next = 15;
            return regeneratorRuntime.awrap(UpdateDoc(contact_us, {
              _id: ObjectId(_id)
            }, obj, {}));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            _context4.next = 8;
            return regeneratorRuntime.awrap(DeleteDoccs(contact_us, {
              _id: ObjectId(_id)
            }));
  ...
  router['list'] = function _callee5(req, res) {
    var skip, limit, field, order, search, sort, query, finalquery, list, fullcount, data, length, result;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 8;
            return regeneratorRuntime.awrap(GetAggregationDoc(contact_us, finalquery));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 7;
            return regeneratorRuntime.awrap(GetAggregationDoc(contact_us, query));
  ...
  router['export'] = function _callee7(req, res) {
    var skip, limit, field, order, search, sort, query, list, fieldNames, finaldata, _ref, parse, csv;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            if (list && checkArray(list) && list.length > 0) {
              fieldNames = ["Created On", "Name", "E-mail", "Phone", "Subject", "Message"], finaldata = list.map(function (item) {
                return {
